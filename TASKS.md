...
Generated by Elyos task-decomposition agent on 2026-06-29. All 27 files in `tasks/` are
schema-valid (validated against the Elyos Task JSON spec). The seed file
`oncology-data-literacy-editorial-001.json` was pre-existing; the remaining 26 files were
generated from this backlog.

| File | Milestone | Type | Risk | Deliverable |
|---|---|---|---|---|
| oncology-data-literacy-editorial-001.json | M0 | design-spec | medium | document |
| oncology-data-literacy-curriculum-002.json | M0 | design-spec | medium | document |
| oncology-data-literacy-licensing-003.json | M0 | data | medium | document |
| oncology-data-literacy-platform-004.json | M0 | code | low | pr |
| oncology-data-literacy-reviewers-005.json | M0 | research | medium | document |
| oncology-data-literacy-pilot-006.json | M0 | writing | medium | document |
| oncology-data-literacy-sources-007.json | M1 | data | medium | dataset |
| oncology-data-literacy-datasets-008.json | M1 | data | medium | dataset |
| oncology-data-literacy-citations-009.json | M1 | code | low | pr |
| oncology-data-literacy-rates-010.json | M2 | writing | medium | document |
| oncology-data-literacy-rates-011.json | M2 | writing | medium | document |
| oncology-data-literacy-survival-012.json | M3 | writing | **high** | document |
| oncology-data-literacy-survival-013.json | M3 | writing | **high** | document |
| oncology-data-literacy-screening-014.json | M4 | writing | **high** | document |
| oncology-data-literacy-screening-015.json | M4 | code | **high** | pr |
| oncology-data-literacy-assessment-016.json | M5 | writing | medium | document |
| oncology-data-literacy-eval-017.json | M5 | code | medium | pr |
| oncology-data-literacy-a11y-018.json | M5 | code | low | pr |
| oncology-data-literacy-partner-019.json | M6 | research | **high** | document |
| oncology-data-literacy-delivery-020.json | M6 | maintenance | **high** | document |
| oncology-data-literacy-ops-021.json | M7 | maintenance | medium | document |
| oncology-data-literacy-i18n-022.json | Backlog | writing | **high** | translation |
| oncology-data-literacy-cases-023.json | Backlog | writing | **high** | document |
| oncology-data-literacy-journalism-024.json | Backlog | writing | medium | document |
| oncology-data-literacy-educator-025.json | Backlog | writing | medium | document |
| oncology-data-literacy-hazard-026.json | Backlog | writing | medium | document |
| oncology-data-literacy-notebook-027.json | Backlog | code | low | pr |

**Fan-out:** none — no dimensions were explicitly enumerated in TASKS.md that warranted
fan-out (the `i18n-022` translation task lists no specific languages; the backlog `cases-023`
lists example types but not individual cancer types as separate tasks).

**Validation:** `node validate-tasks.mjs tasks/` → 27 valid, 0 invalid. ALL VALID.
